...
public class Register extends javax.swing.JFrame {
    ...
    public Register() {
        ...
        lblDefaultEmail.setVisible(true);
        lblHoverEmail.setVisible(false);
        lblContainEmail.setVisible(false);
    ...
    private void localizeAuthScreen() {
        ...
        lblTitle.setText(I18nManager.getString("auth.register.header.title"));
        lblUnderstandTitle.setText(I18nManager.getString("auth.register.confirm"));
        btnNotAcount.setText(I18nManager.getString("auth.register.newacount"));
        lblHoverUser.setText(I18nManager.getString("auth.register.hover.user"));
        lblDefaultUser.setText(I18nManager.getString("auth.register.default.user"));
        lblHoverPassword.setText(I18nManager.getString("auth.register.hover.password"));
        lblDefaultPassword.setText(I18nManager.getString("auth.register.default.password"));
        lblHoverEmail.setText(I18nManager.getString("auth.register.hover.email"));
        lblDefaultEmail.setText(I18nManager.getString("auth.register.default.email"));
    ...
    private void initComponents() {
        ...
        lblContainEmail = new javax.swing.JLabel();
        lblHoverPassword = new javax.swing.JLabel();
        lblHoverEmail = new javax.swing.JLabel();
        lblDefaultEmail = new javax.swing.JLabel();
        ...
        lblDefaultUser.setBounds(515, 300, 247, 25);
        ...
        lblHoverUser.setBounds(515, 292, 182, 14);
        ...
        lblContainUser.setBounds(730, 292, 35, 14);
        ...
        usernameField.setBounds(507, 288, 265, 49);
        ...
        btnNotAcount.setBounds(495, 538, 330, 25);
        ...
        lblContainPassword.setBounds(730, 413, 35, 14);

        lblContainEmail.setFont(FonteUtils.carregarRobotoBold(11f));
        lblContainEmail.setForeground(new java.awt.Color(102, 107, 111));
        lblContainEmail.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblContainEmail.setText("0 / 50");
        getContentPane().add(lblContainEmail);
        lblContainEmail.setBounds(730, 353, 35, 14);
        ...
        lblHoverPassword.setBounds(515, 413, 182, 14);

        lblHoverEmail.setFont(FonteUtils.carregarRobotoBold(11f));
        lblHoverEmail.setForeground(new java.awt.Color(40, 127, 206));
        lblHoverEmail.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        lblHoverEmail.setText("Email");
        getContentPane().add(lblHoverEmail);
        lblHoverEmail.setBounds(515, 353, 182, 14);

        lblDefaultEmail.setFont(FonteUtils.carregarRobotoBold(14f));
        lblDefaultEmail.setForeground(new java.awt.Color(94, 99, 103));
        lblDefaultEmail.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        lblDefaultEmail.setText("Email");
        getContentPane().add(lblDefaultEmail);
        lblDefaultEmail.setBounds(515, 360, 247, 25);
        ...
        lblDefaultPassword.setBounds(515, 420, 247, 25);
        ...
        passwordField.setBounds(507, 408, 265, 49);
        ...
        emailField.setBounds(507, 348, 265, 49);
        ...
        lblUnderstandTitle.setBounds(549, 501, 182, 14);
        ...
        submitButton.setBounds(507, 491, 268, 36);
        ...
        pnlButtonUnderstand.setBounds(507, 491, 268, 36);
        ...
        lblTitle.setBounds(504, 219, 450, 40);
        getContentPane().add(lblLogo);
        lblLogo.setBounds(624, 157, 30, 30);
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        ...
        try {
            CTCONTAB.registrarUsuario(usernameField.getText(), emailField.getText(), passwordField.getText());
            MensagemUtil.exibirSucesso("Sucesso! Sua conta foi criada. Agora você faz parte do nosso time e já pode aproveitar todos os recursos disponíveis.");
            dispose();
            new Login().setVisible(true);
        } catch (ClassNotFoundException x) {
            MensagemUtil.exibirErro("Erro técnico: o driver JDBC necessário para a conexão não foi localizado. Por favor, valide as bibliotecas do sistema.");
        } catch (SQLException x) {
            if (x.getMessage().contains("Duplicate entry")) {
                MensagemUtil.exibirErro("Identificamos que este perfil já existe em nossa base. Que tal fazer login agora ou solicitar uma nova senha de acesso?");
            } else {
    ...
    private void emailFieldFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_emailFieldFocusGained
        lblDefaultEmail.setVisible(false);
        lblHoverEmail.setVisible(true);
        lblContainEmail.setVisible(true);
    ...
    private void emailFieldKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_emailFieldKeyReleased
        updateFieldCounter(emailField, lblContainEmail);
