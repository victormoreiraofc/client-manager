...
public class TelaAdminTable extends javax.swing.JFrame {
    ...
    public TelaAdminTable(Usuario usuario) {
        ...
        addHoverLabel(btnCadastrar, "Auditoria");
    ...
    private void carregarDadosRelatorios() {
        ...
        try {
            double totalClientes = (double) Data.CTCONTAB.clienteTotalRegis() / 1000.0;
            lblRelatorioNovoNumero.setText(df.format(totalClientes));

            double totalRelatorios = (double) Data.CTCONTAB.totalRelatorios() / 1000.0;
            lblRelatorioPendenteNumero.setText(df.format(totalRelatorios));

            double totalTarefas = (double) Data.CTCONTAB.tarefaTotalRegis() / 1000.0;
            lblRelatorioConcluidoNumero.setText(df.format(totalTarefas));

            String ultimoFuncionario = Data.CTCONTAB.ultimoUsuarioRegistrado();

            if (ultimoFuncionario.equals("N/A")) {
                lblFuncionarioDoMesNome.setText("Nenhum registro");
            } else {
                lblFuncionarioDoMesNome.setText(ultimoFuncionario);
            }
    ...
    private void initComponents() {
        ...
        lblFuncionarioDoMesTitulo.setText("Ultimo Funcionário Registrado");
        ...
        lblRelatorioConcluidoTitulo.setText("Total de Tarefas Registradas");
        ...
        lblRelatorioPendenteTitulo.setText("Total de Relatórios Registrados");
        ...
        lblRelatorioNovoTitulo.setText("Total de Clientes Registrados");
        ...
        lblTituloPagina.setText("ADMINISTRAÇÃO");
