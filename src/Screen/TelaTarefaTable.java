...
public class TelaTarefaTable extends javax.swing.JFrame {
    ...
    public TelaTarefaTable(Usuario usuario) {
        ...
        try {
            java.net.URL url = getClass().getResource("/images/Tasks Icon Active.png");
            if (url == null) {
                System.err.println(
                        "Imagem não encontrada. Verifique: /images/Tasks Icon Active.png ou src/images/Tasks Icon Active.png");
            } else {
                java.awt.Image img = javax.imageio.ImageIO.read(url)
                        .getScaledInstance(22, 22, java.awt.Image.SCALE_SMOOTH);
                btnTarefas.setIcon(new javax.swing.ImageIcon(img));
                aplicarHoverIcon(btnTarefas, "/images/Tasks Icon Active.png", "/images/Tasks Icon Hover.png", 22, 22);
            }
        } catch (Exception ex) {
            ex.printStackTrace();
        }
        ...
        try {
            ...
            if (url == null) {
                System.err.println(
                        "Imagem não encontrada. Verifique: /images/New Task Icon.png ou src/images/New Task Icon.png");
            } else {
                java.awt.Image img = javax.imageio.ImageIO.read(url)
                        .getScaledInstance(22, 22, java.awt.Image.SCALE_SMOOTH);
        ...
        try {
            java.net.URL url = getClass().getResource("/images/Task Pendent Icon.png");
            if (url == null) {
                System.err.println(
                        "Imagem não encontrada. Verifique: /images/Task Pendent Icon.png ou src/images/Task Pendent Icon.png");
            } else {
                java.awt.Image img = javax.imageio.ImageIO.read(url)
                        .getScaledInstance(22, 22, java.awt.Image.SCALE_SMOOTH);
        ...
        try {
            java.net.URL url = getClass().getResource("/images/Task Sucess Icon.png");
            if (url == null) {
                System.err.println(
                        "Imagem não encontrada. Verifique: /images/Task Sucess Icon.png ou src/images/Task Sucess Icon.png");
            } else {
                java.awt.Image img = javax.imageio.ImageIO.read(url)
                        .getScaledInstance(22, 22, java.awt.Image.SCALE_SMOOTH);
    ...
    private void initComponents() {
        ...
        lblNome.setText("NOME DO RELATÓRIO");
        lblNome.setToolTipText("");
        getContentPane().add(lblNome);
        lblNome.setBounds(220, 280, 170, 16);
