...
public class TelaRelatorioTable extends javax.swing.JFrame {
    ...
    public class TableRender extends DefaultTableCellRenderer {
        ...
        public Component getTableCellRendererComponent(JTable table, Object value,
            ...
            if (!isSelected) {
                ...
                if (modelColumn == 0 || modelColumn == 3) {
    ...
    private void aplicarPaddingNasColunas() {
        ...
        int larguraStatus = xDoTituloData - xDoTituloStatus;
        jTable1.getColumnModel().getColumn(2).setPreferredWidth(larguraStatus);

        int larguraData = xDoTituloAcoes - xDoTituloData;
        jTable1.getColumnModel().getColumn(3).setPreferredWidth(larguraData);
    ...
    private void filtrarRelatorios() {
        ...
        List<Relatorio> listarRelatorios = new ArrayList<>();

        for (Relatorio relatorio : listarRelatorios) {
            if (relatorio.getNomeRelatorio().toLowerCase().contains(filtro)) {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String[] {
                        "ID", "NOME DO RELATORIO", "STATUS", "DATA DE CADASTRO", "AÇÃO 1", "AÇÃO 2", "AÇÃO 3"
                }) {
        ...
        JPanelBackground.setBorder(null);
